...
{
    const sb64::detail::Letter input{std::vector<bool>{false, true, false, true}};
...
{
    const sb64::detail::Letter input{0b10000001};
...
{
    const sb64::detail::Letter input{std::vector<bool>{}};
...
{
    const sb64::detail::Letter input{std::vector<bool>{true}};
