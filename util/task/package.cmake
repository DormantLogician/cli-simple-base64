...
if (CMAKE_HOST_SYSTEM_NAME STREQUAL "Linux")
    execute_process(COMMAND ${CPACK_EXE} -G "DEB" --config CPackConfig.cmake WORKING_DIRECTORY ${BUILT_DIR} COMMAND_ERROR_IS_FATAL ANY)
...
elseif(CMAKE_HOST_SYSTEM_NAME STREQUAL "Windows")
    execute_process(COMMAND ${CPACK_EXE} -G "NSIS" --config CPackConfig.cmake WORKING_DIRECTORY ${BUILT_DIR} COMMAND_ERROR_IS_FATAL ANY)
    execute_process(COMMAND ${CPACK_EXE} -G "ZIP" --config CPackSourceConfig.cmake WORKING_DIRECTORY ${BUILT_DIR} COMMAND_ERROR_IS_FATAL ANY)
elseif(CMAKE_HOST_SYSTEM_NAME STREQUAL "Darwin")
    execute_process(COMMAND ${CPACK_EXE} -G "DragNDrop" --config CPackConfig.cmake WORKING_DIRECTORY ${BUILT_DIR} COMMAND_ERROR_IS_FATAL ANY)
    execute_process(COMMAND ${CPACK_EXE} -G "ZIP" --config CPackSourceConfig.cmake WORKING_DIRECTORY ${BUILT_DIR} COMMAND_ERROR_IS_FATAL ANY)
else()
    execute_process(COMMAND ${CPACK_EXE} --config CPackConfig.cmake WORKING_DIRECTORY ${BUILT_DIR} COMMAND_ERROR_IS_FATAL ANY)
    execute_process(COMMAND ${CPACK_EXE} -G "ZIP" --config CPackSourceConfig.cmake WORKING_DIRECTORY ${BUILT_DIR} COMMAND_ERROR_IS_FATAL ANY)
endif()
